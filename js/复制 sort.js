...
function initials() {//公众号排序
    ...
    $.each(initials, function(index, value) {//添加首字母标签'<div class="sort_letter" id="'+ value +'">' + value + '</div>'
    	var html = '<li class="mui-table-view-cell sort_letter" id="'+value+'">' +value + '</li>';
        SortBox.append(html);
    });
    if(num!=0){
    	//var  htmls = '<li class="mui-table-view-cell sort_letter" id="default">#</li>';
    	//SortBox.append(htmls);
