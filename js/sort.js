...
$(function(){
		...
		$('.initials ul').on('tap','li',function(){
            var _this=$(this);
...
function initials() {//公众号排序
    ...
    $.each(initials, function(index, value) {//添加首字母标签
        ...
        SortBox.append('<li class="mui-table-view-cell sort_letter" id="'+value+'">' +value + '</li>');
    });
    if(num!=0){
    	SortBox.append('<li class="mui-table-view-cell sort_letter" id="default">#</li>')
